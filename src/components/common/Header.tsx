...
export default function Example() {
  ...
  return (
    <header className="bg-white">
      <div className="max-w-7xl justify-end mx-auto px-6 gap-2 lg:px-10 hidden lg:flex cursor-pointer">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <NavLink to="#">
                  <div className="-mx-3 flex items-center rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50  max-w-7xl justify-start  gap-2 lg:px-10 cursor-pointer">
                    <div className="cart relative">
                      <span className="text-white bg-blue-400 h-6 w-6 rounded-full text-center border-blue-400 absolute top-[-15px] right-[-12px] font-semibold">
                        1
                      </span>
